...
<head>
    ...
    <link href="resources/css/admin/maincontent.css" rel="stylesheet" />
</head>
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h1 mb-0 text-gray-800">전체 강의</h1>
                    </div>
                    <!-- Content Row -->
                    <div class="row">
                        <!-- Area Menu -->
                            ...
                            <div class="card shadow mb-4">
                                ...
                                <div
                                    ...
                                    <div class="dropdown no-arrow">
                                        <a href="lectureinsert.mdo" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm">강의 추가</a>
                                    </div>
                                </div>
                            </div>
                            <div class="contentbody">
                                <div class="contentvalue"></div>
                            </div>
                        </div>
                        <!-- Area Menu -->
                        <div class="col-xl-12 col-lg-7">
                            <div class="card shadow mb-4">
                                ...
                                <div
                                    class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                                    <h3 class="m-0 font-weight-bold text-primary">문법</h3>
                                    <div class="dropdown no-arrow">
                        ...
                        <div class="col-xl-12 col-lg-7">
                            <div class="card shadow mb-4">
                                ...
                                <div
                                    class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                                    <h3 class="m-0 font-weight-bold text-primary">어휘</h3>
                                    <div class="dropdown no-arrow">
                                        <a href="#" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm">교재 추가</a>
                                    </div>
                                </div>
                        ...
                        <div class="col-xl-12 col-lg-7">
                            <div class="card shadow mb-4">
                                ...
                                <div
                                    class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                                    <h3 class="m-0 font-weight-bold text-primary">듣기</h3>
                                    <div class="dropdown no-arrow">
                                        <a href="#" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm">교재 추가</a>
                                    </div>
                                </div>
                        ...
                        <div class="col-xl-12 col-lg-7">
                            <div class="card shadow mb-4">
                                ...
                                <div
                                    class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                                    <h3 class="m-0 font-weight-bold text-primary">내신</h3>
                                    <div class="dropdown no-arrow">
                                        <a href="#" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm">교재 추가</a>
                                    </div>
                                </div>
