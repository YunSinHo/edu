                    ...
                    <div class="row">
	                    <div class="col-xl-12 col-lg-7">
	                        ...
	                        <div class="card shadow mb-4">
	                        	<form id="form1" name="NoticeVO" method="POST" onsubmit="return onclickOk()" action="insertnotice.mdo">
	                                ...
	                                <!-- Card Body -->
	                                <div class="card-body">
	                                	제목 : <input type="text" name="notice_title"><br><br>
	                                	작성 학원 : <input type="text" name="notice_name"><br><br>
	                                	공지 내용<br>
