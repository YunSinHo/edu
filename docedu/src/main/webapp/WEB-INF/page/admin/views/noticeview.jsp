<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8"%>
<!DOCTYPE html>
<%@ page import="com.docedu.web.admin.vo.NoticeVO"%>
<html lang="ko">
<head>
    <meta charset="utf-8">
                    ...
                    <div class="row">
                        ...
                        <div class="col-xl-12 col-lg-7">
                            <div class="card shadow mb-4">
                                ...
                                <!-- Card Body -->
                                <div class="card-body">
                                	제목 : <input type="text" value="${notice_view.notice_title }" readonly><br><br>
                                	작성 학원 : <input type="text" value="${notice_view.notice_name }" readonly><br><br>
                                	작성 날짜 : <input type="text" value="${notice_view.notice_date }" readonly><br><br>
                                	공지 내용<br>
                                	<textarea>${notice_view.notice_content }</textarea>
                                </div>
                            </div>
                        </div>
                    </div>
