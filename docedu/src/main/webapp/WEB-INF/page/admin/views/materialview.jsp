<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8"%>
<!DOCTYPE html>
<%@ page import="com.docedu.web.admin.vo.MaterialVO"%>
<html lang="ko">
<head>
    <meta charset="utf-8">
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item dropdown no-arrow mx-1">
                            ...
                            <div class="dropdown-list dropdown-menu dropdown-menu-right shadow animated--grow-in"
                                ...
                                <a class="dropdown-item text-center small text-gray-500" href="#">공지사항으로 이동</a>
                            </div>
                        </li>
                        ...
                        <li class="nav-item dropdown no-arrow mx-1">
                            ...
                            <div class="dropdown-list dropdown-menu dropdown-menu-right shadow animated--grow-in"
                                ...
                                <a class="dropdown-item text-center small text-gray-500" href="#">메세지함으로 이동</a>
                            </div>
                        </li>
                        ...
                        <div class="col-xl-12 col-lg-7">
                            <div class="card shadow mb-4">
                                ...
                                <div
                                    ...
                                    <h3 class="m-0 font-weight-bold text-primary">자료실</h3>
                                    <div>
                                    	<button class="shadow-sm bg-body rounded" id="">수정</button>
                                    	<button class="shadow-sm bg-body rounded" id="">삭제</button>
                                    </div>
                                </div>
                                <!-- Card Body -->
                                <div class="card-body">
                                	제목 : <input type="text" value="${material_view.material_title }" readonly><br><br>
                                	작성 학원 : <input type="text" value="${material_view.material_name }" readonly><br><br>
                                	작성 날짜 : <input type="text" value="${material_view.material_date }" readonly><br><br>
                                	공지 내용<br>
                                	<textarea>${material_view.material_content }</textarea>
                                </div>
                            </div>
                        </div>
                    </div>
