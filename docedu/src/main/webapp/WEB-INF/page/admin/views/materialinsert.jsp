                    ...
                    <div class="row">
	                    <div class="col-xl-12 col-lg-7">
	                        ...
	                        <div class="card shadow mb-4">
	                        	<form id="form1" name="MaterialVO" method="POST" onsubmit="return onclickOk()" action="insertmaterial.mdo">
	                                <!-- Card Header - Dropdown -->
	                                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
	                                    <h3 class="m-0 font-weight-bold text-primary">자료실 작성</h3>
	                                    <input type="submit" class="shadow-sm bg-body rounded" id="" value="등록">
	                                </div>
	                                <!-- Card Body -->
	                                <div class="card-body">
	                                	제목 : <input type="text" name="material_title"><br><br>
	                                	작성 학원 : <input type="text" name="material_name"><br><br>
	                                	공지 내용<br>
	                                	<textarea name="material_content"></textarea>
	                                </div>
	                            </form>
	                        </div>
                        </div>
