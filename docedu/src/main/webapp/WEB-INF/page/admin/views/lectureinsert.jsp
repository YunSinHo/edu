        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    <!-- Page Heading -->
                    <h1 class="h1 mb-2 text-gray-800">강의 추가</h1>
                    <hr>

                    <!-- DataTales Example -->
                    <div class="card shadow mb-4">
                        <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                            <h6 class="m-0 font-weight-bold text-primary">강의 추가</h6>
                            <input type="button" class="shadow-sm bg-body rounded" id="testbtn" value="강의 등록">
                        </div>
                        <div class="card-body">
		...
		$('#testbtn').click(function(){
			...
			$.ajax({
				...
				success : function(data) {
					alert("success!");
					window.location.href = "mainlecture.mdo";
			     },
				error : function() {
					alert("error");
				}
